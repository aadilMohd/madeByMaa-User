...
class DashboardRepo implements DashboardRepoInterface{
  ...
  @override
  Future<bool> saveWelcomeIntroStatus(bool status) async {
    return await sharedPreferences.setBool(AppConstants.welcomeIntro, status);
  }

  @override
  bool getWelcomeIntroStatus() {
    return sharedPreferences.getBool(AppConstants.welcomeIntro) ?? false;
  }
