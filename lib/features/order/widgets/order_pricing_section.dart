    ...
    return Container(
      ...
      child: Column(children: [
        ...
        decoration: BoxDecoration(
          ...
          // border: Border.all(color: Colors.black)
          boxShadow: [
            BoxShadow(color: Colors.grey,blurRadius: 2,spreadRadius: 2,blurStyle: BlurStyle.outer)
          ]
        ),
          child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
            Text("Summary",style: TextStyle(fontSize: Dimensions.fontSizeLarge,fontWeight: FontWeight.w600),),
Divider(),
            // Total
            ...
            Divider(thickness: 1, color: Color(0xff090018).withOpacity(0.5)),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text('discount'.tr, style: robotoRegular.copyWith(color: Color(0xff009951))),
              Text('(-)   ₹${PriceConverter.convertPrice(discount)}', style: robotoRegular.copyWith(color: Color(0xff009951)), textDirection: TextDirection.ltr),
            ]),
            const SizedBox(height: Dimensions.paddingSizeSmall),
            ...
            couponDiscount > 0 ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text('coupon_discount'.tr, style: robotoRegular.copyWith(color: Color(0xff009951))),
              Text(
            ...
            order.paymentMethod == 'partial_payment' ? Container(
              ...
              child: DottedBorder(
                ...
                : Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text(subscription ? 'subtotal'.tr : 'total'.tr, style: robotoMedium.copyWith(fontWeight: FontWeight.w600,
                fontSize: Dimensions.fontSizeLarge, color: Color(0xff090018),
              )),
              Text("₹"+
                PriceConverter.convertPrice(total), textDirection: TextDirection.ltr,
                style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Color(0xff090018),fontWeight: FontWeight.w600,),
              ),
            ]),
