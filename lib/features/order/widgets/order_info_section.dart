  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Container(
            ...
            child:
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Text(
                    '${subscription ? 'subscription_id'.tr : 'order_id'.tr}:${order.id}',
                    ...
                    child: Center(
                      child: Text(
                        ...
                        (order.orderStatus == "confirmed")
                            ?"Confirmed"
                            :
                        (order.orderStatus == "processing" || order.orderStatus == "handover" || order.orderStatus == "assigned")
                            ?"Cooking"
                            :
                        ...
                        (order.orderStatus == "delivered")
                          ...
                          (order.orderStatus == "arrived_at_pickup")
                            ? "Arrived At Kitchen"
                            ...
                            ? "Out For Delivery"
                            : (order.orderStatus == "return" || order.orderStatus == "canceled")
                            ? "Canceled"
                            : "Out For Delivery",
              ...
              Column(children: [
                Row(children: [
                  ...
                  Container(
                    ...
                    child: Text(order.cutlery! ? 'yes'.tr : 'no'.tr,
      ...
      InkWell(
        ...
        child: Container(margin: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
          decoration: BoxDecoration(
            color: Theme.of(context).cardColor,
            borderRadius:
                BorderRadius.circular(isDesktop ? Dimensions.radiusDefault : Dimensions.radiusDefault),
          ...
          child:
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            !isDesktop
                ? Text('restaurant'.tr, style: robotoMedium)
                : const SizedBox(),
                    ...
                    (showChatPermission &&
                      ...
                      // crossAxisAlignment: CrossAxisAlignment.end,
                          ...
                          children: [
                            ...
                            decoration: BoxDecoration(color: Get.theme.primaryColor,borderRadius: BorderRadius.circular(Dimensions.radiusSmall)),
                            child: Row(
                              children: [
                                Image.asset(Images.msg,
                                    height: 15, width: 15, fit: BoxFit.cover),
                                const SizedBox(width: 10,),
                                Text('chat'.tr,style: TextStyle(color: Get.theme.cardColor,fontSize: Dimensions.fontSizeLarge),)
                              ],
                            ),
                                                  ),
                                                ),
