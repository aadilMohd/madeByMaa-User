...
class OrderService implements OrderServiceInterface {
  ...
  Future getOrderCurrentstatus(String addloguuid,) async {
    return await orderRepositoryInterface.getOrderCurrentstatus(addloguuid);
  }
  ...
  dynamic _sortOutProductAddToCard(List<Variation>? orderedVariation, Product currentFood, OrderDetailsModel orderDetailsModel, {bool getOnlineCart = true}){
    ...
    CartModel cartModel = CartModel(
      ...
      quantity, addOnIdWithQtnList, addOnsList, false, currentFood, selectedVariations, currentFood.quantityLimit,false
    );
