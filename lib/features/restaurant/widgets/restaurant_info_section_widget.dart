                ...
                builder: (context, scrollingRate) {
                  return !isDesktop ? Container(
                    ...
                    child: Align(
                      ...
                      child: Container(
                        height: (hasCoupon ? 260 : 110) - (scrollingRate * 25),
                        ...
                        child: Padding(
                          ...
                          child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            isDesktop?InfoViewWidget(restaurant: restaurant, restController: restController, scrollingRate: scrollingRate):
                            InfoViewWidget1(restaurant: restaurant, restController: restController, scrollingRate: scrollingRate),
                            isDesktop?SizedBox(height: Dimensions.paddingSizeLarge - (scrollingRate * (isDesktop ? 2 : Dimensions.paddingSizeLarge))):SizedBox(),
