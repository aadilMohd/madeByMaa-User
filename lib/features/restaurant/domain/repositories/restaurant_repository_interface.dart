...
abstract class RestaurantRepositoryInterface extends RepositoryInterface {
  ...
  @override
  Future<RestaurantModel?> getList({int? offset, String? filterBy, int? topRated, int? discount, int? veg, int? nonVeg,int? cuisine, bool fromMap = false, bool isSix = false});
