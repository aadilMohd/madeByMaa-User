...
abstract class RestaurantServiceInterface {
  ...
  Future<RestaurantModel?> getRestaurantList(int offset, String filterBy, int topRated, int discount, int veg, int nonVeg, int cuisine, {bool fromMap = false,bool isSix = false});
  ...
  int setPopular(int popular);
  int setLatest(int latest);
