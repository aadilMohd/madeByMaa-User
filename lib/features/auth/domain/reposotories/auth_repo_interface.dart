...
abstract class AuthRepoInterface<SignUpModel> extends RepositoryInterface<SignUpModel>{
  ...
  Future<Response> registration1(SignUpModel signUpModel);
  Future<Response> login({String? phone, String? password});
  Future<Response> login1({String? phone});
  Future<Response> uploadPhoto(UploadPhotoBody uploadPhotoBody );
  Future<Response> loginOtp({String? phone,String?otp});
