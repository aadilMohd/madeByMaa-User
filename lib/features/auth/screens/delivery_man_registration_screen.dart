  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        ...
        appBar:
        CustomAppBarWidget1(title: 'delivery_man_registration'.tr,
          onBackPressed: () {
            ...
            : Column(children: [
              Padding(
                ...
                child: Column(children: [
                  Text(
                    'complete_registration_process_to_serve_as_delivery_man_in_this_platform'.tr,textAlign: TextAlign.center,maxLines: 2,
                    style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault,fontWeight: FontWeight.w400, color: Theme.of(context).hintColor),
                  ),
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: Container(
                          height: 4, // Height for the filled portion
                      ...
                      Expanded(
                        child: Container(
                          height: 2, // Height for the unfilled background
                          decoration: BoxDecoration(
                      ...
                      Visibility(
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            Row(children: [
                              Text('deliveryman_info'.tr, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge,fontWeight: FontWeight.w700)),
                            ...
                            Text(
                              'this_info_will_need_for_delivery_app_login'.tr,textAlign: TextAlign.center,maxLines: 2,
                              style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault,fontWeight: FontWeight.w400, color: Theme.of(context).hintColor),
                            ),
                            const SizedBox(height: Dimensions.paddingSizeSmall),
                                ...
                                ClipRRect(
                                  ...
                                  child: deliverymanController.pickedImage != null ? GetPlatform.isWeb ? Image.network(
                                    ...
                                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                      ...
                                      Image.asset("assets/image/add_a_photo.png", color: Color(0xffE0E0E0)),
                                    //  Icon(, size: 40, color: Theme.of(context).disabledColor.withOpacity(0.7)),
                                      const SizedBox(height: Dimensions.paddingSizeSmall),

                                      Padding(
                                        padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge),
                                        child: Text(
                                          'upload_profile_picture1'.tr,
                            ...
                            Container(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                ...
                                Text("Name & Number",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 14),),
                                    const SizedBox(height: Dimensions.paddingSizeLarge),
                                ...
                                CustomTextFieldWidget1(
                                  titleText: ResponsiveHelper.isDesktop(context) ? 'phone'.tr : "",
                                ...
                                Container(
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        const SizedBox(height: Dimensions.paddingSizeLarge),
                                        Text("Email & Password",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 14),),
                                        const SizedBox(height: Dimensions.paddingSizeLarge),
                                ...
                                return InkWell(
                                  ...
                                  child: DottedBorder(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                        const SizedBox(height: Dimensions.paddingSizeSmall),
                                        Image.asset("assets/image/add_a_photo.png", color: Color(0xffE0E0E0)),//background: #E0E0E0;
                          ...
                          Container(
                            ...
                            child: Column(children: [
                              ...
                              CustomTextFieldWidget1(
                                ...
                                inputAction: TextInputAction.done,
                                labelText: 'enter_identity_number'.tr,
                                required: false,
  ...
  Widget buttonView(){
    return GetBuilder<DeliverymanRegistrationController>(builder: (deliverymanController) {
      return Container(
        ...
        child: CustomButtonWidget(color: Colors.black,
          ...
          onPressed: !deliverymanController.acceptTerms ? null : () async {
            if(deliverymanController.dmStatus == 0.1 && !ResponsiveHelper.isDesktop(context)){
              ...
              if(deliverymanController.dmStatus == 0.1){
                ...
                deliverymanController.dmStatusChange(1.0);
              }
            }else{
