      ...
      return Column(crossAxisAlignment: isRightMessage ? CrossAxisAlignment.end : CrossAxisAlignment.start , children: [
        ...
        Padding(
          ...
          child: Column(
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, mainAxisAlignment: isRightMessage ? MainAxisAlignment.end : MainAxisAlignment.start,
                children: [
              ...
              Flexible(child: Column(crossAxisAlignment: isRightMessage ? CrossAxisAlignment.end : CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                ...
                if(currentMessage.message != null) Flexible(child: Container(
                  decoration: BoxDecoration(
                    ...
                    borderRadius:
                    isRightMessage && (isSameUserWithNextMessage || isSameUserWithPreviousMessage)
                        ? BorderRadius.only(
                      ...
                      bottomRight: Radius.circular(isSameUserWithPreviousMessage && !isLTR && previousMessageHasChatTime =="" ? Dimensions.radiusSmall :Dimensions.radiusExtraLarge + 5),
                        ...
                        BorderRadius.only(
                            ...
                            // bottomLeft: Radius.circular(Dimensions.radiusExtraLarge+5),
                            bottomRight: Radius.circular(Dimensions.radiusExtraLarge+5),
                  ...
                  child: InkWell(
                    ...
                    child: Text(
                      ...
                      style: robotoRegular.copyWith(fontWeight: FontWeight.w400,
