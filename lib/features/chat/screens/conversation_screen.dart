      ...
      return Scaffold(
        ...
        Column(children: [
          ...
          (Get.find<AuthController>().isLoggedIn() && conversation != null) ? Center(child: Container(
            ...
            suffixIcon: chatController.searchConversationModel != null ? Icons.close : null,
          ...
          Expanded(child: Get.find<AuthController>().isLoggedIn() ? (conversation != null) ?
          RefreshIndicator(
            onRefresh: () async {
        ...
        productView: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return (type == UserType.admin.name)
                ? const SizedBox() : (type == chatController.type)
                ? Container(
              ...
              child: CustomInkWellWidget(
                onTap: () {
                  if(user != null) {
                    Get.find<ChatController>().name=user.fName;
                  ...
                  child: Stack(children: [
                    Row(
                      ...
                      Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        user!.ownerName==null?SizedBox():   Text(user.ownerName!,style: TextStyle(color: const Color(0xffA7A7A7),fontSize: Dimensions.fontSizeExtraSmall),),
                        ...
                        //   child: Text(
                        //     DateConverter.localDateToIsoStringAMPM(DateConverter.dateTimeStringToDate1(
