          ...
          appBar: !ResponsiveHelper.isDesktop(context)
            ...
            title: Row(children: [
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                chatController.messageModel!.conversation!.receiverType=="admin"
                    ?
                Container(
                    padding: const EdgeInsets.symmetric(vertical: 5,horizontal: 10),
                    decoration: BoxDecoration(color: Colors.black,borderRadius: BorderRadius.circular(Dimensions.radiusSmall)),
                    child: Text("Admin",style: TextStyle(color: Get.theme.cardColor,fontSize: Dimensions.fontSizeExtraSmall,fontWeight: FontWeight.w400),))
                    :const SizedBox(),

                chatController.messageModel != null ?
                Text(
                  // widget.user!.fName==null?"":  '${widget.user!.fName}'
                  chatController.messageModel!.conversation!.receiverType=="admin"
                      ?"madeByMaa": Get.find<ChatController>().name.toString(),

                 // ' ${chatController.messageModel!.conversation!.receiver!.fName}'
                 // ' ${chatController.messageModel!.conversation!.receiver!.lName}',

                  style: robotoRegular.copyWith(color: const Color(0xff524A61)),
                ) : Container(
                          ...
                          InkWell(
                            ...
                            child: Container(
                                ...
                                Padding(
                                  ...
                                  child: CustomAssetImageWidget(Images.addImg, width: 25, height: 25, color: Theme.of(context).hintColor),
                                )),
                          ),
