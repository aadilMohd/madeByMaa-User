...
class SearchController extends GetxController implements GetxService {
  ...
  void sortFoodSearchList() {
    log("kklllkk ${jsonEncode(_allProductList)}");
    _searchProductList = searchServiceInterface.sortFoodSearchList(_allProductList, _upperValue, _lowerValue, _rating, _veg, _nonVeg, _isAvailableFoods, _isDiscountedFoods, _sortIndex, _priceSortIndex,_ordertype);
    update();
  }
