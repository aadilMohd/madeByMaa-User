      ...
      body: _isLoggedIn ? GetBuilder<CouponController>(builder: (couponController) {
        return (couponController.couponList != null && _toolTipControllerList != null) ? couponController.couponList!.isNotEmpty ? RefreshIndicator(
          ...
          child: SingleChildScrollView(
                ...
                FooterViewWidget(
                  child: Center(child: SizedBox(width: Dimensions.webMaxWidth, child: GridView.builder(
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      childAspectRatio: ResponsiveHelper.isMobile(context) ? 2.7 : 3,
                    ),
            ...
            :
        // NoDataScreen(title: 'no_coupon_available'.tr, isEmptyCoupon: true)
            Center(child: Column(
              children: [
                Icon(Icons.not_interested,size: 40,),
                SizedBox(height: Dimensions.paddingSizeSmall,),
                Text("No Coupon Available",style: TextStyle(fontWeight: FontWeight.w500,fontSize: Dimensions.fontSizeLarge),),
              ],
            ),)
