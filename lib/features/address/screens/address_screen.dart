  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<AddressController>(builder: (addressController) {
      return Scaffold (
        ...
        bottomNavigationBar: Container(height: 80,color: Colors.transparent,
          ...
          child: InkWell(onTap: () =>
            ...
            ),child: Center(child: Text("Add More Address",style: TextStyle(color: Get.theme.cardColor,fontWeight: FontWeight.w400),),),),
          ),
        ),
        ...
        // ResponsiveHelper.isDesktop(context) ? FloatingActionButtonLocation.centerFloat : null,
