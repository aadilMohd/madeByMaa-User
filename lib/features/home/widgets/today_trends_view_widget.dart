        ...
        return (campaignController.itemCampaignList != null && campaignController.itemCampaignList!.isEmpty) ? const SizedBox() : Padding(
          ...
          child: Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeDefault,top: Dimensions.paddingSizeDefault, left: Dimensions.paddingSizeDefault, right: Dimensions.paddingSizeDefault),
                  child: Align(
                      alignment: Alignment.center,
                      child: Text('trending_now'.tr,style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w600))),
                ),
