        ...
        Container(
          ...
          child: ClipOval(
            child: CustomImageWidget(
              image: image,
              fit: BoxFit.cover,
              height: fromSearchPage || fromCuisinesPage
                  ? 55 : 56,
              width: fromSearchPage || fromCuisinesPage ? 55 : 56,
            ),
          ),
        ),
        SizedBox(height: fromSearchPage || fromCuisinesPage? Dimensions.paddingSizeSmall:Dimensions.paddingSizeLarge,),

        Text( name, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall,fontWeight: FontWeight.w500),
          maxLines: 1, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center,
        ),
