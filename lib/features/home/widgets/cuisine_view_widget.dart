...
import 'package:stackfood_multivendor/features/home/widgets/cuisine_bottom_sheet.dart';
...
class CuisineViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CuisineController>(builder: (cuisineController) {
        return (cuisineController.cuisineModel != null && cuisineController.cuisineModel!.cuisines!.isEmpty) ? const SizedBox() :
        Container(
            ...
            children: [
              Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  Text('cuisines'.tr, style: robotoBold.copyWith(
                      fontSize: 18,
              ...
              GridView.builder(
                ...
                itemCount: cuisineController.cuisineModel!.cuisines!.length > 12
                    ? 12
                ...
                itemBuilder: (context, index) {
                  if (index == 11 && cuisineController.cuisineModel!.cuisines!.length > 12) {
                    return CustomInkWellWidget(
                      ...
                      onTap: () {
                        showModalBottomSheet(
                          ...
                          ,builder: (context) {
                          return CuisineBottomSheet();
                        },);
                      },
                      child: Column(
                        children: [
                          Image.asset(Images.blueCircleDown,height: 56,),
                          SizedBox(height: Dimensions.paddingSizeLarge,),
                          Text("See all",style: TextStyle(color: Get.theme.primaryColor),)
                        ],
                      )
                    );
                  } else {
