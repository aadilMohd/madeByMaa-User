...
import '../../checkout/widgets/time_slot_section.dart';
        ...
        return GetBuilder<CartController>(
          builder: (cartController) {
            ...
            if (Get.find<CheckoutController>().restaurant != null) {
              todayClosed = Get.find<CheckoutController>().isRestaurantClosed(
                  DateTime.now(),
                  Get.find<CheckoutController>().restaurant!.active!,
                  Get.find<CheckoutController>().restaurant!.schedules);
              tomorrowClosed = Get.find<CheckoutController>()
                  .isRestaurantClosed(
                      DateTime.now().add(const Duration(days: 1)),
                      Get.find<CheckoutController>().restaurant!.active!,
                      Get.find<CheckoutController>().restaurant!.schedules);
              taxPercent = Get.find<CheckoutController>().restaurant!.tax;
            }
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: RichText(
                                                                                  ...
                                                                                  text: TextSpan(children: [
                                                                                    TextSpan(text: 'currently_the_restaurant_is_unavailable_the_restaurant_will_be_available_at'.tr, style: robotoRegular.copyWith(color: Colors.red)),
                                                                                    // const TextSpan(text: ' '),
                                                                                    // TextSpan(
