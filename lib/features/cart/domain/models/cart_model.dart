...
class CartModel {
  ...
  CartModel(
    ...
    _availablefoodtime = availablefoodtime;
  }
  ...
  bool? get availablefoodtime => _availablefoodtime;
  ...
  CartModel.fromJson(Map<String, dynamic> json) {
    ...
    _availablefoodtime = json['available_food_time']??false;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['available_food_time'] = _availablefoodtime;
