...
class _OrderSuccessfulScreenState extends State<OrderSuccessfulScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: ResponsiveHelper.isDesktop(context) ? const WebMenuBar() : AppBar(surfaceTintColor: Colors.white,shadowColor: Colors.grey,elevation: 1,leading: IconButton(onPressed: (){
        Get.offAll(()=>const DashboardScreen(pageIndex: 0));

      },icon: const Icon(Icons.arrow_back),),title: Text("Cart",style: TextStyle(fontSize: Dimensions.fontSizeLarge,fontWeight: FontWeight.bold),),centerTitle: true,),
        ...
        return orderController.trackModel != null ? Center(child: SingleChildScrollView(
          ...
          child: FooterViewWidget(
            child: SizedBox(width: Dimensions.webMaxWidth, child: Column(
              ...
              Image.asset(success ? Images.checkLogo : Images.warning, width: 141, height: 141),
              const SizedBox(height: Dimensions.paddingSizeLarge),

              Text(
                success ? 'Order Placed\nSuccessfully'.tr : 'your_order_is_failed_to_place'.tr,
                style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge,fontWeight: FontWeight.w600,color: const Color(0xff090018)),
              ),
              ...
              Padding(
                ...
                child: CustomButtonWidget(radius: 30,
                  width: ResponsiveHelper.isDesktop(context) ? 300 : 160,
