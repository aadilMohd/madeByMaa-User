    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      (!isGuestLoggedIn && fromCart && !checkoutController.subscriptionOrder && checkoutController.restaurant!.scheduleOrder!) ?  Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            Text('Delivery Time Slot'.tr, style: robotoMedium),
                ...
                Builder(
                  builder: (context) {
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                      //  Text(Get.find<CartController>().date ,style: TextStyle(fontWeight: FontWeight.w600),),
                        const SizedBox(width: Dimensions.paddingSizeExtraSmall,),
                        Text(
                    ...
                    checkoutController.preferableTime.toString()=="Now"?
                        checkoutController.preferableTime:
                          "${Get.find<CartController>().date} \n${checkoutController.preferableTime}"
