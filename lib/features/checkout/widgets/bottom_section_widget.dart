                  ...
                  Row(
                    children: [
                      Checkbox(
                          ...
                          splashRadius: 0,
                          value: checkoutController.checkCancelOrder,
                          onChanged: (bool? value) {

                              checkoutController.checkCancelOrder= value!;
                      ...
                      Expanded(
                        child: Text(
                          "Once an instant delivery order is placed, it cannot be cancelled.",
                          style: TextStyle(
                  ...
                  Row(
                    children: [
                      Checkbox(
                          visualDensity: VisualDensity.standard,
                          splashRadius: 0,
                          value: checkoutController.checkScheduleOrder,

                          onChanged: (bool? value) {
                            checkoutController.checkScheduleOrder = value!;
                            checkoutController.update();
                          }
                        // onChanged:toggleCheckbox,
                      ),
                      Expanded(
                        child: Text(
                          "Scheduled orders can only be cancelled after seller confirmation or at least 2 hours before the scheduled delivery time.",
                          style: TextStyle(
                              fontWeight: FontWeight.w500,
                              fontSize: Dimensions.fontSizeSmall,
                              fontFamily: 'Poppins',
          ...
          isDesktop
            ...
            child: Column(
              children: [
                ...
                OrderPlaceButton(isCheckOut: true,
                  checkoutController: widget.checkoutController,
    ...
    return Container(
      ...
      child: Theme(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Row(children: [
              Text('${'GST'.tr} ${widget.taxIncluded ? 'tax_included'.tr : ''}',
                  style: robotoRegular),
              Text('(${widget.taxPercent}%)',
                  style: robotoRegular, textDirection: TextDirection.ltr),
            ]),
            Row(children: [
              Text('(+) ', style: robotoRegular),
          ...
          SizedBox(
              height: widget.checkoutController.orderType != 'take_away' &&
                      ...
                      widget.checkoutController.distance == -1
                          ...
                          : (widget.deliveryCharge == 0 ||
                              ...
                              : Row(children: [
                                  Text('(+) ', style: robotoRegular),
                                  Text(
                                    "₹${PriceConverter.convertPrice(widget.deliveryCharge)}",
                                    style: robotoRegular,
                                    textDirection: TextDirection.ltr,
                                  )
                                ]),
          ...
          SizedBox(
              height: Get.find<SplashController>()
                  ...
                  ? Dimensions.paddingSizeSmall
                  : 0),
          (isDesktop || widget.checkoutController.isPartialPay) &&
                  widget.checkoutController.subscriptionOrder
              ? Column(
                  children: [
                    Divider(
                  ...
                  Row(
                      ...
                      children: [
                        Text('subscription_order_count'.tr,
                            style: robotoMedium),
                        Text(widget.subscriptionQty.toString(),
                            style: robotoMedium),
                      ]),
                  Padding(
                    padding: const EdgeInsets.symmetric(
          ...
          widget.checkoutController.isPartialPay &&
              ...
              : const SizedBox(),
          isDesktop && !widget.checkoutController.subscriptionOrder
              ? Padding(
                  padding: const EdgeInsets.symmetric(
                      vertical: Dimensions.paddingSizeSmall),
                  child: Divider(
