...
class ProfileController extends GetxController implements GetxService {
  ...
  Future<ResponseModel> updateUserInfoLogin(UserInfoModel updateUserModel, String token) async {
    _isLoading = true;
    update();
    ResponseModel responseModel = await profileServiceInterface.updateProfileLogin(updateUserModel, _pickedFile, token);
    if(responseModel.isSuccess){
