...
ThemeData dark = ThemeData(
  fontFamily: "Poppins",
  primaryColor: const Color(0xFF5E1EAA),
  ...
  textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(foregroundColor: const Color(0xFF5E1EAA))),
  colorScheme: const ColorScheme.dark(
          primary: Color(0xFF5E1EAA),
          tertiary: Color(0xff6165D7),
          tertiaryContainer: Color(0xff171DB6),
          secondary: Color(0xFF5E1EAA))
