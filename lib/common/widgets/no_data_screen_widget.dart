      ...
      child: Column(mainAxisAlignment: fromAddress ? MainAxisAlignment.start : MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
        ...
        Center(
          child: CustomAssetImageWidget(
            isEmptyAddress ? Images.emptyAddress : isEmptyCart ? Images.noCart : isEmptyChat ? Images.emptyChat : isEmptyOrder ? Images.emptyOrder
            ...
            width: isDesktop ? 130 : 110, height: isDesktop ? 130 : 110,
          ),
        ),
        SizedBox(height: fromAddress ? 10 : 15),
