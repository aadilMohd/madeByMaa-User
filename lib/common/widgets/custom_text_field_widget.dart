    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          textAlign: widget.textAlign,readOnly: widget.readonly ??false,
          ...
          decoration: InputDecoration(
            ...
            label: widget.showLabelText ? Text.rich(TextSpan(children: [
              TextSpan(text: widget.labelText ?? '', style: robotoRegular.copyWith(fontSize: widget.levelTextSize ?? Dimensions.fontSizeLarge, color: Colors.black)),
            ...
            prefixIcon:  widget.isPhone ? SizedBox(width: 95, child: Row(children: [
              Container(
                  ...
                  child: Center(
                    child: CodePickerWidget(enabled: false,
                      flagWidth: 25,
...
class CustomTextFieldWidget1 extends StatefulWidget {
  final String titleText;
  final String hintText;
  final TextEditingController? controller;
  final FocusNode? focusNode;
  ...
  @override
  CustomTextFieldWidget1State createState() => CustomTextFieldWidget1State();
}

class CustomTextFieldWidget1State extends State<CustomTextFieldWidget1> {
  bool _obscureText = true;
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
              borderSide: BorderSide(style: widget.showBorder ? BorderStyle.solid : BorderStyle.none, width: 1, color: Color(0xffE0E0E0)),
            ),
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
              borderSide: BorderSide(style: widget.showBorder ? BorderStyle.solid : BorderStyle.none, width: 1, color: Color(0xffE0E0E0)),
            ...
            hintStyle: robotoRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).hintColor),
            filled: true,
            labelStyle : widget.showLabelText ? robotoRegular.copyWith(backgroundColor: Colors.white,
                fontSize: Dimensions.fontSizeDefault,
                color: Color(0xff7E7E7E)):null,
            errorStyle: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
            enabled: true,
            label: widget.showLabelText ? Container(
            decoration: BoxDecoration(  color: Colors.white,borderRadius: BorderRadius.circular(5)),
              padding: EdgeInsets.symmetric(horizontal: 10),
              child: Text.rich(TextSpan(children: [
                TextSpan(text: "${widget.labelText}"?? '', style: robotoRegular.copyWith(fontSize: widget.levelTextSize ?? Dimensions.fontSizeLarge, fontWeight: FontWeight.w400,color: Color(0xff7E7E7E))),
                if(widget.required && widget.labelText != null)
                  TextSpan(text : ' *', style: robotoRegular.copyWith(color: Theme.of(context).colorScheme.error, fontSize: Dimensions.fontSizeLarge)),
                if(widget.isEnabled == false)
                  TextSpan(text: widget.fromUpdateProfile ? ' (${'phone_number_can_not_be_edited'.tr})' : ' (${'non_changeable'.tr})', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).colorScheme.error)),
