...
class CustomFavouriteWidget extends StatefulWidget {
  ...
  final bool? restra;
  final double? size;
  const CustomFavouriteWidget({super.key, this.restaurant, this.product, this.isRestaurant = false, required this.isWished, this.size = 25, this.restra=false});
    ...
    return InkWell(
      ...
      child: ScaleTransition(
        ...
        child: CustomAssetImageWidget(
            widget.isWished
                ? (widget.restra==true?Images.blackHeart:Images.favouriteIcon)
                : (widget.restra==true?Images.blackHeartt:Images.unFavouriteIcon),
