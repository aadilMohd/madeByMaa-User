...
class Product {
  ...
  Product({
    ...
    this.scheduleorders,
    this.instantorder,
    this.superCategories, // ✅ added here
  });
  ...
  Product.fromJson(Map<String, dynamic> json) {
    ...
    scheduleorders = json['schedule_orders'] ?? false;
    instantorder = json['instant_order'] ?? false;

    /// ✅ Parse super_categories
    if (json['super_categories'] != null) {
      superCategories = [];
      json['super_categories'].forEach((v) {
        superCategories!.add(SuperCategory.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['schedule_orders'] = scheduleorders;

    /// ✅ Add to JSON
    if (superCategories != null) {
      data['super_categories'] =
          superCategories!.map((v) => v.toJson()).toList();
    }
...
class SuperCategory {
  ...
  SuperCategory({this.id, this.name});
...
//   bool? scheduleorders;
//   bool? instantorder;
//   //schedule_orders: null, instant_order: null,
//   Product(
//       {this.id,
//         this.minDeliveryTime,
//   this.maxDeliveryTime,
