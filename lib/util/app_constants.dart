...
class AppConstants {
  static const String appName = 'madeByMaa';
  static const double appVersion = 7.5;
  static const String fontFamily = 'Poppins';
  static const String addlofApiKey = 'b7a7d1d8-d61f-41e8-9e2a-43542a3c5409';
  static const bool payInWevView = false;
  static const String webHostedUrl = 'https://deshboard.madebymaa.store';

  static const String baseUrl = 'https://deshboard.madebymaa.store';
  static const String thirdpartydevbaseUrl = 'https://dev.adloggs.com';
  static const String thirdpartyProdbaseUrl = 'https://app.adloggs.com';
  static const String categoryUri = '/api/v1/categories';
  static const String thirdpartyCurrentstatusofOrderUri =
      '/aa/oporder/getcurrentstatus';
  ...
  static const String foodReviews = '/api/v1/products/reviews/';
  ...
  static const String photoUpload = '/api/v1/auth/photo-upload';
  ...
  static const String getSuperCategoryUri = '/api/v1/getSuperCategory';
  // static const String getFoodAndCategoryBySuperCategoryUri =
  //     '/api/v1/getFoodandCategoryBySuperCategory';

  static const String getFoodAndCategoryBySuperCategoryUri =
      '/api/v1/getFoodBySuperCategory';
  ...
  // static const String updateProfileUri = '/api/v1/update-profile';
  static const String updateProfileUri = '/api/v1/auth/sign-up';
  ...
  static const String availableTimesUri =
      '/api/v1/customer/order/available-times/';
  ...
  static const String welcomeIntro = 'welcome_intro';
