...
import 'package:stackfood_multivendor/features/restaurant/domain/repositories/super_category_repo.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.lazyPut(() =>
      SuperCategoryRepo(apiClient: Get.find(), sharedPreferences: Get.find()));

  //Controller
  Get.lazyPut(() => SuperCategoryController(superCategoryRepo: Get.find()));
